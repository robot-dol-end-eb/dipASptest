<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="testasp.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server" 
                    ItemType="testasp.Models.Category" 
        ...
        <tr>
         ...
         <tr>
            <td><asp:Label ID="LabelAddAudioFile" runat="server">Audio File:</asp:Label></td><!--> Аудио <!-->
            <td>
                <asp:FileUpload ID="ProductAudio" runat="server" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Text="* Audio path required." ControlToValidate="ProductAudio" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
    </table>
    <p></p>
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="testasp.Models.Product" 
