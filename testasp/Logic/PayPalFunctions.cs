...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-w3dtg1314663_api1.business.example.com";
    private string APIPassword = "HD6NTU4V82XE3SE6";
    private string APISignature = "ASPe8-KHtqMMQmiDKJKGVOJckD8JAOWogdcmpevxWlVCAF6TJMLHhNfZ";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:44332/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:44332/Checkout/CheckoutCancel.aspx";
        ...
        using (testasp.Logic.ShoppingCartActions myCartOrders = new testasp.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            testasp.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
